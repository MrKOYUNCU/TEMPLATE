    ...
    <div class="container-fluid">
        ...
        <table class="table table-bordered">
            ...
            if (isset($_POST["add_portfolio"])) {
                ...
                $query = "INSERT INTO portfolios (portfolio_name,portfolio_category,portfolio_img_sm,portfolio_img_bg) VALUES('$portfolio_name','$portfolio_category','$portfolio_image_sm ','$portfolio_image_bg')";
            ...
            if (isset($_POST["edit_portfolio"])) {
                ...
                if (empty($portfolio_img_sm)) {
                    ...
                    $select_portfolio_sm_img = mysqli_query($conn,$query2);
                    while ($row=mysqli_fetch_array($select_portfolio_sm_img)) {
                        $portfolio_img_sm = $row["portfolio_img_sm"];
                    }
                }
                if (empty($portfolio_img_bg)) {
                    $query2 = "SELECT * FROM portfolios WHERE portfolio_id='$_POST[portfolio_id]'";
                    $select_portfolio_bg_img = mysqli_query($conn,$query2);
                    while ($row=mysqli_fetch_array($select_portfolio_bg_img)) {
                ...
                $edit_portfolio = mysqli_query($conn,$sql_query2);
                header("Location:portfolios.php");
                            ...
                            <div class="modal-body">
                                <form action="" method="post" enctype ="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="portfolio_category"  class="form-group">
                                            <?php
                                    ...
                                    <div class="form-group">
                                        <img width ="100px" height ="100px" src="../img/<?php echo $portfolio_img_sm; ?>">
                                        <input type="file" class="form-control" name="image">
                                    </div>

                                    <div class="form-group">
                                    <img width ="100px" height ="100px" src="../img/<?php echo $portfolio_img_bg; ?>">
                    ...
                    <div class="modal-body">
                        <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="portfolio_category"  class="form-group">
                                            <?php
                                                $edit_category_query = "SELECT * FROM categories";
                                                $edit_category_run = mysqli_query($conn,$edit_category_query);
